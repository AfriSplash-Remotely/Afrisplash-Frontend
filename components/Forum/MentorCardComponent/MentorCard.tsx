...
export default function MentorCard() {
    return (
        <div
            className='w-full rounded-lg p-4 shadow-sm bg-purple-300 space-y-40 mt-2'
        // style="background-image:url('/assets/hire-talent-assets/img_1.png');"
        >
            <div className='flex justify-between'>
                <div className='p-2  rounded-full mentorCardBtn'>
            ...
            <div className='py-4 mt-3'>
                <div className='flex  items-center'>
                    <h3 className='text-xl text-white_2 font-bold' >Mubarak Show</h3>
                    <div className='pl-2'>:rainbow_flag:</div>
                </div>
                ...
                <div className='mt-2 flex items-center'>
                    ...
                    <h5 className='pl-2 text-lg text-white_2'>Senior Developer</h5>
