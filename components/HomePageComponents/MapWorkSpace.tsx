    ...
    <section className={`w-full ${styles.bg_gray} py-28`}>
      <div className="w-10/12 mx-auto flex flex-wrap justify-between items-center">
        ...
        <div className={`w-full md:w-5/12 space-y-5`}>
          <h3 className="text-4xl w-9/12 font-medium">Your office away from the office</h3>
          <p className="w-10/12 text-gray-500">
            Your remote work lifestyle deserves a workspace that supports it. That&apos;s why we&apos;ve curated over
            5000 workspaces across Africa you can choose from. Do your best work, no matter where you are
          </p>
          <div className={`flex items-center space-x-6`}>
            <Button classes={`bg-dark_blue text-gray-200 py-4 px-10 rounded-lg`} text="Lease a space" />
