...
export default function Filter(): JSX.Element {
  return (
    <div className="relative flex justify-center  w-full mt-12 py-8">
      <div className="relative border bg-white w-full  rounded-lg">
        <div className="absolute top-0 left-0 flex">
          <div className="bg-primary_green rounded-tl-lg py-2 px-8 text-white text-center">
            Saved search
          </div>
          <div className="bg-[#D9DEDC] text-center text-white text-2xl px-3 flex items-center">
            +
          </div>
        </div>
        ...
        <div className="absolute bottom-0 p-3 mt-20 bg-[#D9DEDC] w-full rounded-b-lg">
