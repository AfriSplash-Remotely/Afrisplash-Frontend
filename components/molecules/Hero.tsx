...
const Hero = (): JSX.Element => {
  return (
    <div className="flex flex-col items-center justify-between bg-primary_yellow  px-4 md:flex-row-reverse md:px-10 xl:px-[96px]">
      ...
      <div className="md:w-1/2 xl:w-1/3">
        <div className="my-7 mt-10 flex flex-row flex-wrap items-center gap-2">
          <Link href="" passHref>
            <Button
              tag="a"
              classes=" border-[1px] bg-secondary_yellow text-white rounded-lg text-sm w-[142px] max-w-[100%] h-[40px] flex flex-row items-center justify-center cursor-pointer hover:opacity-70"
            >
              Remote Jobs
            </Button>
          </Link>
          <Link href="" passHref>
            <Button
              tag="a"
              classes=" border-[1px] bg-secondary_yellow text-white rounded-lg text-sm w-[142px] h-[40px] flex flex-row items-center justify-center cursor-pointer hover:opacity-70"
            >
              International Jobs
            </Button>
          </Link>
