...
import location from "../../assets/icons/locate.svg"
  ...
  return (
    ...
    >
      <div className='px-12 py-6'>
        <div>
          <h1 className='text-dark_black font-medium  text-lg md:text-5xl text-center'>Compnay Name</h1>
          <p className='mt-2 text-grey_3 text-lg text-center font-medium'>Job title</p>
        </div>
        <div className='mt-8 flex justify-around'>
          <div >
            ...
            <p className='text-primary_green  font-bold text-lg ml-8 mt-1'>Remote</p>
          </div>
          <div >
            <div className="flex gap-2">
              <Image src={location} alt='icon' />
        ...
        <div className='py-12 px-12'>
          <div className='py-4'>
            <h3 className='text-dark_black font-bold text-base'>JOB DESCRIPTION</h3>
          ...
          <div className='py-4'>
            <h3 className='text-dark_black font-bold text-base'>REQUIREMENTS</h3>
            <p className='text-base text-dark_black mt-2'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus error ullam eos ratione. Veniam numquam similique, officia exercitationem explicabo aut quisquam doloribus blanditiis voluptatibus repudiandae eveniet magnam in. Voluptatibus, natus?
            </p>
          </div>
