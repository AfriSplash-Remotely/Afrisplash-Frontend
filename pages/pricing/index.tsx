...
const Pricing = (): JSX.Element => {
  return (
    <div className="">
      <Navigation />
      <section className="bg-gray-100 w-full px-16 pb-16">
        <h3 className="text-center mx-auto py-12 text-2xl font-semibold">
          Featured Jobs
        </h3>
        ...
        <div className="card-pricing pb-6">
          ...
          <div className="card-price flex flex-row justify-left md:flex-wrap gap-4">
            <div className="card-info flex-1 md:flex-1 w-4/12 h-auto  border-2 rounded-xl">
              <div className="p-4">
                <h4 className="text-black text-lg text-left font-semibold">
                  Silver Plan
                </h4>
                <p className="text-sm font-normal text-gray-900 py-4">
                  1 job credit can be used to feature 1 job post
                </p>
                <h3 className="text-3xl text-black text-left font-semibold py-4">
                  $20.00
                </h3>
              ...
              <div className="p-4">
                <h4 className="text-black text-m text-left pb-6 font-semibold">
                  Includes:
                </h4>
                <div className="flex gap-3 py-2 justify-left">
                  <CheckCircleIcon
                    color="rgba(214, 236, 220, 1)"
                    width={25}
                    height={25}
                  />
                  <p>1 Job Credit</p>
            ...
            <div className="card-info flex-1 md:flex-1 w-4/12 h-auto bg-green-900 border-2 rounded-xl">
              <div className="p-4">
                <div className="flex justify-between">
                  <h4 className="text-yellow-400 text-lg text-left font-semibold">
                    Bronze Plan
                  </h4>
                ...
                <p className="text-sm font-normal text-white py-4">
                  1 job credit can be used to feature 1 job post
                </p>
                <h3 className="text-3xl text-yellow-400 text-left font-semibold py-4">
                  $50.00
                </h3>
              ...
              <hr className="w-full text-black" />
              <div className="p-4">
                <h4 className="text-white text-m text-left pb-6 font-semibold">
                  Includes:
                </h4>
                <div className="flex gap-3 py-2 justify-left">
                  <CheckCircleIcon
        ...
        <button className="border-2 flex justify-center border-green-300 mx-auto align-items-center mb-5 p-5">
          Post a Free Job
        </button>
