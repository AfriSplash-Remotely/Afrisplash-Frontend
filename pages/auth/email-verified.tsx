  ...
  return (
    <div className="p-1">
      <div className="max-w-[1440px] h-[1027px] bg-[#FFF] mr-auto ml-auto">
        ...
        <div className="max-w-[560px] h-[739px] l-[320px] bg-[#fff] md:shadow-[4px_4px_32px_rgba(0,0,0,0.1)] md:backdrop-opacity-20 rounded-[24px] w-full mt-12 flex box-border mr-auto ml-auto">
          <div className="p-1">
