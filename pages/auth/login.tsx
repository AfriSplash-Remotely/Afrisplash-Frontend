      ...
      <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
        <div className="w-full ">
          <input
            ...
            {...register("email", { required: `${translate("Email is required")}` })}
          />
          {errors.email && (
        ...
        >
          <span className="flex gap-4 mx-auto item-center justify-center">{isLoading && <LoadingIcon />}{translate("Log in")}</span>
        </button>
      </form>
