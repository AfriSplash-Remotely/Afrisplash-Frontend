        ...
        <div className="px-8 sm:px-12 md:px-16 mb-8">
            ...
            <form className="flex flex-wrap justify-around text-gray-500 mb-4">
                ...
                >
                    ...
                    <input
                        ...
                        disabled={workExp}
                        onChange={(e) =>
                            dispatch(companyNameAction(e.target.value))
                        }
                    />
                </label>
                <label
                ...
                >
                    ...
                    <input
                        ...
                        disabled={workExp}
                        onChange={(e) =>
                            dispatch(positionHeldAction(e.target.value))
                        }
                    />
                </label>
                <label
                ...
                >
                    ...
                    <input
                        ...
                        disabled={workExp}
                        onChange={(e) =>
                            dispatch(startDateAction(e.target.value))
                        }
                    />
                </label>
                <label
                ...
                >
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            dispatch(endDateAction(e.target.value))
                        }
                    />
                </label>
            </form>
            ...
            <div className="px-4 py-8">
                <label htmlFor="bio">
                    ...
                    />
                    <p className="text-right text-sm text-gray-500">{jobDescription.length}/150</p>
                </label>
            </div>
        </div>
    )
