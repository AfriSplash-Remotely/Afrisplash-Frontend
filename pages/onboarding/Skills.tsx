...
import { experienceAction, skillsAction, skillsCategoryAction } from "../../store/candidateOnboarding/formSlice"
...
const Skills = () => {
    ...
    const btnDefault = "text-black border border-gray-500 px-20 py-2.5 rounded-full"

    const dispatch = useDispatch()
    const {skillsCategory, experience, skills} = useSelector((state: RootState) => state.form)
