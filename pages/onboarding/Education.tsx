...
import { degreeAction, eduDescriptionAction, eduEndDateAction, eduStartDateAction, fieldStudyAction, institutionNameAction } from "../../store/candidateOnboarding/formSlice"
...
const Education = () => {
    const {institutionName, degree, fieldStudy, eduStartDate, eduEndDate, eduDescription} = useSelector((state: RootState) => state.form)
  ...
  return (
    <div className="px-6 sm:px-12 md:px-16 mb-8">
            ...
            <form className="flex flex-wrap justify-between text-gray-500 mb-4">
                ...
                <label
                    htmlFor="degree"
                    className="basis-[100%] md:basis-[45%] mt-5"
                >
                    <p>Degree</p>
                    <Select
                        id="degree"
            ...
            <label htmlFor="bio">
                ...
                />
                <p className="text-right text-sm text-gray-500">{eduDescription.length}/150</p>
            </label>
            </div>
        </div>
  );
